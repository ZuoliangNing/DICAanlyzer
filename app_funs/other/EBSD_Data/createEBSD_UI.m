...
PreprocessPanel = uipanel( GridLayoutMain, ...
    'Title', DisplayNames.EBSDImport_PreprocessPanel_Title );
...
PreprocessMethodNames = struct2cell( structfun( @(obj) ...
    obj.Name, app.EBSDPreprocessMethods , ...
    'UniformOutput', false ) );
PreprocessMethodDropdown = uidropdown( GridLayoutPreprocessMethod, ...
    'Items', PreprocessMethodNames, ...
    'ItemsData', fieldnames( app.EBSDPreprocessMethods ), ...
    'FontSize', MagnifiedFontSize );
PreprocessMethodDropdown.Value = DataMethod;
...
Parameters = app.EBSDPreprocessMethods.( DataMethod ).Parameters;
