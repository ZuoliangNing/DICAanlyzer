function UserMaterialFormats_OXFORD_UMAT_250603( inpFile, grains )
...
cubicslip       = 0;
gf              = 0.3;      % Ti_250603
C11             = 164000;   % Ti_250603
C12             = 93000;    % Ti_250603
C44             = 48200;    % Ti_250603
C13             = 68400;    % Ti_250603
C33             = 187400;   % Ti_250603
caratio         = 1.587;    % Ti_250603
alpha1          = 0;
alpha2          = 0;
alpha3          = 0;
slipmodel       = 1;
...
slipparam_3     = 1;
slipparam_4     = 0.01;
slipparam_5     = 6.8e-20;    % Ti_250603
slipparam_6     = 8.75e12;    % Ti_250603
slipparam_7     = 1;
slipparam_8     = 1.22;       % Ti_250603
creepmodel      = 0;
hardeningmodel  = 2;
...
rho_0           = 0.01;
burger1         = 2.95e-4;      % Ti_250603
burger2         = 5.8e-4;       % Ti_250603
xtauc1          = 400.0; % basal       Ti_250603
xtauc2          = 350; % prismatic     Ti_250603
xtauc3          = 5000.0; % pyramidal   Ti_250603
xtauc4          = 500.0; % pyramidal-1 Ti_250603
xtauc5          = 5000.0; % pyramidal-2 Ti_250603
